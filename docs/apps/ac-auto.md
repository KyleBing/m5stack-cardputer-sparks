...
![acauto-stop](/shots/app_acauto_001.png)
![acauto-auto](/shots/app_acauto_002.png)
![acauto-on](/shots/app_acauto_003.png)
...
返回菜单：展示页按 `ESC` / `GO`。配置页按 `ESC` / `GO` 先关闭配置，再按一次才回主菜单。
