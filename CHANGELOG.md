...
- **ExI2C / InI2C**：扫描会对 `0x10`/`0x60` 做写探测，TEA5767 / RDA5807M 会被打开并一直嘶声；扫完与退出时改为 mute + standby
...
- **版本**：固件 / M5Burner / README 统一为 **v1.12**（`APP_VERSION` / `m5burner.json`）；`APP_UPDATE_TIME` → `2026.08.15`
